...
@Controller
@RequestMapping("/personalDownload")
public class PersonalDownloadController {
    /**
     * 个人操作的服务
     */
    @Resource
    ...
    public Map list(String name, String[] typeArr,@RequestParam(value = "pageNumber", defaultValue = "1") int pageNumber, @RequestParam(defaultValue = "60") int pageSize,String order){
        ...
        List<Map> list = operateService.getMyHistory(userId, "4", beginIndex, pageSize, name,typeArr,order,levelCode,orgId);
     ...
     * @author luzhanzhao
     * @date 2018-11-19
     * description 获取个人下载列表的主页面
     * @return
     */
    @GetMapping("/view")
    public String downloadList(){
        return "/doc/manager/personalcenter/download-list.html";
    }
}
