package com.jxdinfo.doc.manager.exportmanager.service.impl;
 ...
 */
@Service
public class MobileFilesServiceImpl implements MobileFilesService {
     ...
     */
    @Override
    public Map<String, Object> checkEmpSpace(String fileSize,String userId) {
     ...
     */
    @Override
    public List<Map> checkChildCount(List<FsFolder> list, List<Map> childCountList,String userId) {
