package com.jxdinfo.doc.mobileapi.versionmanager.controller;
...
public class MobileVersionController {
    ...
    public ApiResponse setVersion(String oldDocId, String docId){
        ...
        return ApiResponse.data(200,(infoFlag && esFlag && authorityFlag && timeFlag && validOld && validNew && TopFlag && BannerFlag) + "","");
    }
}
