 ...
 */
package com.jxdinfo.doc.mobileapi.docmanager.util;
...
@CrossOrigin
@Controller
@RequestMapping("/mobile/orgUtil")
public class MobileOrgUtil extends BaseController {
...
//        result.add(root);
    ...
    public ApiResponse tree() {
       ...
       for ( int i=0;i<result.size();i++){
        ...
        return ApiResponse.data(200,result2,"");
    }
}
