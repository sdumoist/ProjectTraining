...
layui.use(['jquery', 'tree', 'table', 'util', 'laytpl', 'form', 'layer','HussarAjax', 'Hussar'], function () {
    ...
    TopicBin.initTableView = function () {
        ...
        tableIns = table.render({
            ...
            , url: Hussar.ctxPath+'/component/componentListByWYH?componentName=' + title + '&componentType=' + componentType
        ...
        table.on('tool(topicList)', function (obj) {
            ...
            if (obj.event === 'openView') {
                ...
                /*top.HussarTab.tabAdd("成果认定","/component/componentCognizance?componentId="+obj.data.componentId,"4");*/
                openView('成果认定', '/component/componentCognizance?componentId=' + obj.data.componentId, 760, 500, obj);
            }
        });
    }
    /*打开查看页面*/
...
//                debugger;
    ...
    top.reloadComponentWYH = function () {
        tableIns.reload({
            page: {
                curr: 1
            }
