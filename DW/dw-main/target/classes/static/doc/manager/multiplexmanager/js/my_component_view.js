...
layui.use(['jquery',  'tree', 'table', 'util', 'laytpl', 'form', 'layer','Hussar','HussarAjax'], function () {
    ...
    TopicBin.initTableView = function () {
        ...
        tableIns =table.render({
            ...
            , url: Hussar.ctxPath+'/multiplex/myComponentList?title=' + title
            , request: {
            ...
            , cols: [[
                ...
                {field: 'componentName', title: '成果名称', width: '30%', align: "left"},
                {field: 'componentType', title: '成果类型', width: '15%', align: "center",templet:"#type"},
                {field: 'projectName', title: '复用项目名称', width: '30%', align: "left"},
                {field: 'projectDept', title: '项目所属部门', width: '15%', align: "center"},
            ]] //设置表头
        });
        //.监听选择，记录已选择项
   ...
   ,
        selectProject:function () {
            ...
            parent.projectId=dataArr[0].projectId;
            parent.projectName=dataArr[0].projectName;
            parent.projectDept=dataArr[0].projectDept;
            parent.document.getElementById("projectName").value=dataArr[0].projectName;
