...
layui.use(['jquery',  'tree', 'table', 'util', 'laytpl', 'form', 'layer','laydate','Hussar','HussarAjax'], function () {
    ...
    TopicBin.initTableView = function () {
        ...
        tableIns =table.render({
            ...
            , url: Hussar.ctxPath+'/multiplex/multiplexListByDept?title=' + title + '&deptName=' + deptName+'&dateStart='+dateStart+'&dateEnd='+dateEnd
            , request: {
            ...
            , cols: [[
                ...
                {field: 'projectName', title: '复用项目', width: '15%', align: "left",event: 'opeView', style: 'cursor: pointer;color:#00a4ff'},
                {field: 'projectDept', title: '复用部门', width: '10%', align: "center"},
                {field: 'userName', title: '复用人', width: '7%', align: "center"},
                {field: 'createTimeStr', title: '复用时间', width: '10%', align: "center"},
                {field: 'projectCount', title: '复用成果数量', align: 'center', width: '12%'},
                {field: 'componentName', title: '成果名称',width:'10%',  align: "left"},
                {field: 'organAlias', title: '提报部门', width: '8%', align: "center"},
                {field: 'caUserName', title: '成果提报人', width: '10%', align: "center"},
                {field: 'economize', title: '节省工作量(人/天)', width: '14%', align: "center"}
