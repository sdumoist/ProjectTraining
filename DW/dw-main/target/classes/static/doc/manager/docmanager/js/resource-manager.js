...
layui.use(['form', 'laypage', 'jquery','layer','Hussar','jstree','laytpl'], function() {
    ...
    $("#authorName").click(function(){
        $("<link>")
            .attr({ rel: "stylesheet",
                type: "text/css",
                id:"aothorTree",
                href: "/static/resources/css/jstree.css"
            })
            .appendTo("head");
    ...
    function    initTree(){
        ...
        $tree.jstree({
            core: {
                check_callback: true,
                data: {
                    "url": "/fsFile/getTreeDataLazy?lazy",
                    "data": function (node) {
                        return {"id": node.id,"type" :"1"
                        };
                    }
    ...
    BreakpointUpload.initUploader = function () {
        ...
        uploader = WebUploader.create({
            ...
            pick : {
                id : '#picker',
                label : '<i class="layui-icon" style="margin-right: 3px">&#xea0c;</i>上传',
                multiple:true
            },
