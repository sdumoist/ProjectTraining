...
layui.use(['jquery',  'tree', 'table', 'util', 'laytpl', 'form', 'layer'], function () {
    ...
    TopicBin.initTableView = function () {
        ...
        tableIns =table.render({
            ...
            , url: '/multiplex/projectList?title=' + title.trim()
            , request: {
            ...
            ,even:true
            , cols: [[
                {field: 'pORJECTID', type: 'radio', width: '5%', align: "left"},
   ...
   ,
        selectProject:function () {
          ...
          var checkStatus=  table.checkStatus('topicList');
            ...
            //parent.projectId=checkStatus.data[0].pORJECTID;
            ...
            parent.document.getElementById("projectId").value=checkStatus.data[0].pORJECTID;
            // parent.document.getElementById("meetingTitle").value=checkStatus.data[0].pROJECTNAME+"-中台咨询会议记录";
            // parent.document.getElementById("meetingTitle").title=checkStatus.data[0].pROJECTNAME+"-中台咨询会议记录";
