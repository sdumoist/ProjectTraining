...
layui.use(['jquery',  'tree', 'table', 'util', 'laytpl', 'form', 'layer','Hussar','HussarAjax'], function () {
    ...
    TopicBin.initTableView = function () {
        ...
        tableIns =table.render({
            ...
            , url: Hussar.ctxPath+'/multiplex/selectComponent?title=' + title
            , request: {
            ...
            ,even:true
            , cols: [[
                {field: 'componentId', title: 'id', type: 'checkbox', width: '6%', align: "center"},
                {type: 'numbers', title: '序号', align: 'center', width: '6%'},
                {field: 'componentName', title: '成果名称', width: '51%', align: "left"},
                {field: 'componentType', title: '成果分类', width: '21%', align: "center" ,templet:'#type'},
                {field: 'userName', title: '上传人', width: '16%', align: "center",templet:'showTpl'},
            ]] //设置表头
        });
        //.监听选择，记录已选择项
               ...
               if(dataArr[i].componentType==0){
                ...
                if(adminFlag==7){
                    str="<td class='box'>" +
                        ...
                        "<div class='center' >"+
                        "<input  type='text' class='economize' value='0'  maxlength='3'>"+
                        "</div>"+
                ...
                var innerHtml="  <tr>" +
                    "<td>"+(length+j)+"</td>" +
                    "<td>"+type+"</td>" +
                    "<td style='text-align: left!important;padding-left:10px'>"+dataArr[i].componentName+"</td>" +
