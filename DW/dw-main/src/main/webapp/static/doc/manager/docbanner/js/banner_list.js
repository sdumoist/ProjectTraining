...
layui.use(['jquery',  'tree', 'table', 'util', 'laytpl', 'form', 'layer','Hussar'], function () {
    ...
    TopicBin.initTableView = function () {
        tableIns =table.render({
            ...
            , url: Hussar.ctxPath+'/banner/bannerList' //数据接口
            , request: {
            ...
            ,even:true
            , cols: [[
                {field: 'bannerId', title: 'id', type: 'checkbox', width: '5%', align: "center"},
                {type: 'numbers', title: '序号', align: 'center', width: '5%'},
                {field: 'bannerName', title: 'banner名称', width: '35%', align: "center", event: 'opeView', style: 'cursor: pointer;color:#00a4ff'},
                {field: 'classify', title: 'banner分类', width: '10%', align: "center",
                    templet: function (d) {
                        if (d.classify === "0") {
                            return "文档";
                ...
                {field: 'bannerHref', title: 'banner链接', width: '45%', align: "left"}
            ]] //设置表头
        });
        //.监听选择，记录已选择项
    ...
    active = {
        ...
        , delTopics: function () {
            ...
            layer.confirm('确定要删除所选中的banner吗？', function () {
                $.ajax({
                    type: "post",
                    url: Hussar.ctxPath+"/banner/delBanners",
                    data: {
                        ids: ids
                    },
                    async: false,
