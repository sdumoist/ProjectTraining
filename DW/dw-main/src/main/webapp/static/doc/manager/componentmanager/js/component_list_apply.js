...
layui.use(['jquery',  'tree', 'table', 'util', 'laytpl', 'form', 'layer','Hussar','HussarAjax'], function () {
    ...
    TopicBin.initTableView = function () {
        ...
        tableIns =table.render({
            ...
            , url: Hussar.ctxPath+'/component/componentListByApply?componentName=' + title + '&componentType=' + componentType
            ...
            , cols: [[
                ...
                {field: 'componentName', title: '组件名称', width: '25%', align: "center",event: 'openView', style: 'cursor: pointer;color:#00a4ff'},
                {field: 'componentDescText', title: '组件描述', width: '35%', align: "left"},
...
//                debugger;
    ...
    top.reloadComponentApply =  function(){
        tableIns.reload({
            page: {
                curr: 1
            }
