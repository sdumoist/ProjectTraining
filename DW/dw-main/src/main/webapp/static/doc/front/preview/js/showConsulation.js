...
(function() {
    ...
    var gridView ={
        ...
        init:function(){
            ...
            var id=$("#id").val();
            var url="/Consulation/ConsulationView?consulationId="+id;
            layui.use(['Hussar'], function(){
                var Hussar = layui.Hussar;
        ...
        initPath:function(){
            ...
            layui.use(['Hussar','HussarAjax'], function(){
                ...
                var ajax = new $ax(Hussar.ctxPath + "/Consulation/getConsulation", function(data) {
                    var path ="";
                    if(!!data){


                        path +=" <span><a href='#'target='_blank' data-id='"+data.middlegroundConsulation.consulationId+"'>"+data.middlegroundConsulation.consulationTitle+"</a> </span>";
