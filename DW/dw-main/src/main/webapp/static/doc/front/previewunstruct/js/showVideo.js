    ...
    $(document).ready(function(){
        ...
        /*$.ajax({
            ...
            success:function(data) {
                ...
                filePath = "/preview/video?fileId=" + encodeURIComponent(data.filePath);
                fileName = data.title;
        ...
        var ajax = new $ax(Hussar.ctxPath + "/preview/fileDetail", function(data) {
            ...
            authorId = data.authorId;
            filePath = "/preview/video?fileId=" + encodeURIComponent(data.filePdfPath);
            fileName = data.title;
            fileSuffixName = data.fileSuffixName.toLowerCase();
            ...
            var obj = document.getElementById("title");
            if(fileSuffixName=="mp4"||fileSuffixName=="avi"||fileSuffixName=="wmv"||fileSuffixName=="wav"){  //文档名称前的图片
                $("#title").addClass("type-mp4");
                // obj.style.cssText = "background:url(/static/resources/img/excel.png)no-repeat left center;"
            }
            var author=data.author;
            ...
            document.getElementById("video").load();
                ...
                var checkUploadState = setInterval(function (){
                    ...
                    var ajax = new $ax(Hussar.ctxPath + '/preview/checkVideoState', function(data) {
                        if (data){
                            //关闭定时器
